...
create table content(
    ...
    primary key (id),
    foreign key (channel_id) references channel (id) on delete cascade on update cascade,
    foreign key (publisherUsername) references Publisher (username) on delete cascade on update cascade
);
create table Notification(
    ...
    primary key (id),
    foreign key (related_content_id) references content (id) on delete cascade on update cascade
);
...
create table poll_choices(
    ...
    foreign key(poll_id) references poll(content_id) on delete cascade on update cascade
);
create table admin_ban_user(
    AdminUsername varchar(200) not null,
    Username varchar(200) not null,
    primary key (AdminUsername, Username),
    foreign key (AdminUsername) references Admin(username) on update cascade,
    foreign key (Username) references user(username) on delete cascade on update cascade
);
...
create table publisher_manage_channel(
    ...
    foreign key (publisher_username) references Publisher (username) on delete cascade on update cascade,
    foreign key (channel_id) references channel (id) on delete cascade on update cascade
);
create table Discussion_about_article(
    ...
    foreign key (channel_id, Discussion_id) references Discussion (channel_id, Discussion_id) on delete cascade on update cascade,
    foreign key (Article_id) references article (content_id) on delete cascade on update cascade
);
...
create table solve_HW(
    ...
    foreign key (studentUsername) references Student(username) on delete cascade on update cascade,
    foreign key (HW_id) references homework(content_id) on delete cascade on update cascade
);
create table solve_problem_set(
    ...
    foreign key (studentUsername) references Student(username) on delete cascade on update cascade,
    foreign key (content_id) references ProblemSet(content_id) on delete cascade on update cascade
);
create table solve_quiz(
    ...
    primary key(studentUsername, content_id),
    foreign key (studentUsername) references Student(username) on delete cascade on update cascade,
    foreign key (content_id) references quiz(content_id) on delete cascade on update cascade
);
...
create table vote(
    ...
    foreign key (studentUsername) references Student(username) on delete cascade on update cascade,
    foreign key (poll_id) references poll_choices(poll_id) on delete cascade on update cascade
);
...
create table PS_question(
    ...
    foreign key (question_id) references question(id) on delete cascade on update cascade,
    foreign key (PS_id) references ProblemSet(content_id) on delete cascade on update cascade
);
create table quiz_question(
    ...
    foreign key (question_id) references question(id) on delete cascade on update cascade,
    foreign key (quiz_id) references quiz(content_id) on delete cascade on update cascade
);