    ...
    <div>
        ...
        <div className="flex  flex-row  justify-between m-0 min-w-full bg-amber-100 p-10 ">
			...
			<ul className="list-none flex flex-row mr-8">
                <li className="font-medium mx-3 border-2 border-black px-2 py-1 rounded-xl bg-slate-50 hover:text-white hover:bg-black"><Link to='/Channels'>ExploreChannels</Link></li>
			</ul>
		</div>
        </>
    </div>
