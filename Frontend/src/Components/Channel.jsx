...
const Channel = (props) => {
	...
	const HandleSubmit = (e) => {
		e.preventDefault();
        if(!props.isPrivate){
            // make a post request to tell it 
            return;
        }
        let errors="";
	...
	return (
		<div className=" w-1/2 border border-black mx-4 px-4 py-2 bg-slate-100 rounded-lg">
			<header>
				<h1 className="font-semibold text-2xl px-4">{props.title}</h1>
			</header>
